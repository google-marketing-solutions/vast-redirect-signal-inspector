...
const PAIVastUrl =
  'https://serverside.doubleclick.net/gampad/ads?iu=/21775744923/external/single_ad_samples&sz=640x480&cust_params=sample_ct%3Dlinear&ciu_szs=300x250%2C728x90&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&sss=vast_url_validator_test&ip=1.2.3.4&correlator=';
const IMASdkVastUrl =
...
describe('VastURLParser', () => {
  ...
  it('Should correctly parse a PAI VAST URL', () => {
    ...
    expect(result.params.env).toBe('vp');
    expect(result.params.impl).toBe('s');
    expect(result.params.sss).toBe('vast_url_validator_test');
